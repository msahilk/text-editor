...
func TestDocument(t *testing.T) {
	...
	// New docs should have at least 2 characters (start and end).
	got := doc.Length()
	want := 2
...
// Verify that inserting a character results in the correct document.
...
// Verify that inserting a character at the same position results in the correct document.
...
// Verify that inserting a character between two characters results in the correct document.
func TestIntegrateInsert_BetweenTwoPositions(t *testing.T) {
	...
	// Insert new character between <"1", "c"> and <"2", "t">.
...
func TestLoad(t *testing.T) {
	...
	// Compare loaded file and document
